...
export default class Door extends Phaser.GameObjects.Container {
  ...
  shootYou() {
    ...
    let shot1 = this.scene.add.image(
      this.x,
      this.y,
      "assets",
      this.characterFrame + "shot1"
    );
    let shot2 = this.scene.add.image(
      this.x,
      this.y,
      "assets",
      this.characterFrame + "shot2"
    );
    ...
    let smoke1 = this.scene.add.image(
      this.x,
      this.y,
      "assets",
      this.characterFrame + "smoke1"
    );
    let smoke2 = this.scene.add.image(
      this.x,
      this.y,
      "assets",
      this.characterFrame + "smoke2"
    );
